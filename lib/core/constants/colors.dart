...
class AppColors {
  ...
  static const Color backgroundLightPurple = Color(0xFFEAEEFF);
  ...
  static const Color aiCoral = Color(0xFFFF5722);
  static const Color aiCardBgGreen = Color(0xFFE8F5E9);
  static const Color aiCardBgPurple = Color(0xFFF3E5F5);
